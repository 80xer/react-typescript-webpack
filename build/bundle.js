...
var App = (function (_super) {
    ...
    App.prototype.handSubmit = function (e) {
        e.preventDefault();
        this.setState({
            currentTask: '',
    ...
    App.prototype.renderTasks = function () {
        ...
        return this.state.tasks.map(function (task, index) {
            return (React.createElement("div", { key: task.id, className: "tdl-task" },
                ...
                React.createElement("button", { onClick: function () { return _this.toggleDone(index); } }, task.completed ? 'undo' : 'done')));
        });
    };
    App.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h1", null, "l"),
            React.createElement("form", { onSubmit: function (e) { return _this.handSubmit(e); } },
                React.createElement("input", { type: "text", className: "tdl-input", placeholder: "Add a Task", onChange: function (e) { return _this.setState({ currentTask: e.target.value }); }, value: this.state.currentTask }),
